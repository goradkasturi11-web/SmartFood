            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td>
<?php if (!empty($ngo['ngo_id']) && is_numeric($ngo['ngo_id'])): ?>

    <a href="<?php echo BASE_URL; ?>/index.php?route=admin-verify-ngo&id=<?php echo $ngo['ngo_id']; ?>"
       class="btn btn-sm btn-success"
       onclick="return confirm('Are you sure you want to verify this NGO?');">
        <i class="bi bi-check"></i> Verify
    </a>

    <a href="<?php echo BASE_URL; ?>/index.php?route=admin-reject-ngo&id=<?php echo $ngo['ngo_id']; ?>"
